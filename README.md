...
![screenshot of TTT welcome modal](README-screenshots/SS-TTT-welcome.png)
...
![screenshot of TTT name modal](README-screenshots/SS-TTT-name.png)

- ***The symbol modal:*** You will be prompted to choose the "O" or the "X" symbol as yours. Click either image to continue.
![screenshot of TTT symbol modal](README-screenshots/SS-TTT-symbol.png)
...
![screenshot of TTT turn modal](README-screenshots/SS-TTT-turn.png)
...
![screenshot of TTT gameboard](README-screenshots/SS-TTT-gameboard.png)
![screenshot of TTT gameplay](README-screenshots/SS-TTT-gameplay.png)
![screenshot of TTT win](README-screenshots/SS-TTT-win.png)
...
![screenshot of TTT play again modal](README-screenshots/SS-TTT-play-again.png)
...
- ***The buttons:*** At any point of the game, you may click any of the buttons at the bottom of the screen:
    ...
    ![screenshot of TTT light mode](README-screenshots/SS-TTT-light-mode.png)
...
![screenshot of HM category modal](README-screenshots/SS-HM-category.png)

- ***The difficulty modal:*** Choose a level to continue.
![screenshot of HM difficulty modal](README-screenshots/SS-HM-level.png)
...
![screenshot of HM gameboard](README-screenshots/SS-HM-gameboard.png)
...
![screenshot of HM wrong guess](README-screenshots/SS-HM-wrong-guess.png)
...
![screenshot of HM gameplay](README-screenshots/SS-HM-gameplay.png)
...
![screenshot of HM win](README-screenshots/SS-HM-win.png)Conversely, the game is lost if all of the body parts of the hangman appear before you are able to reveal the target word. Upon your victory or loss, the game will prompt you to play again. Click "OK" to play again, or "CANCEL" to quit the game and go back to the main page of the website. 
![screenshot of HM play again](README-screenshots/SS-HM-play-again.png)
...
![screenshot of HM guess word](README-screenshots/SS-HM-guess-word.png)
...
#### Mini-game 3: Memory Game with Cards

This is the third game designed by Jae Ahn-Benton, where the user plays a simple memory game by matching two cards at a time.

- ***The welcome modal:*** Simply click the "LET'S PLAY" button to continue.
![screenshot of CMG welcome modal](README-screenshots/SS-CMG-welcome.png)
- ***The main game:*** The objective of the game is to make all 26 matches and clear the board. A match is considered two cards with the same color and the same number. For example, the Ace of Hearts and the Ace of Diamonds are a match, but the 10 of Spades and 10 of Diamonds are not a match. 
![screenshot of CMG gameboard](README-screenshots/SS-CMG-gameboard.png)
Click on any of the cards to flip the card. You may flip only two cards at a time, and the message board above will display whether it is a legitimate match or not.  
![screenshot of CMG no match](README-screenshots/SS-CMG-no-match.png)
![screenshot of CMG match](README-screenshots/SS-CMG-match.png)
Once a match is made, the matched pair will disappear from the screen.
![screenshot of CMG card away](README-screenshots/SS-CMG-card-away.png)
The stats board directly below will inform you how long you have been playing, and how many moves you have made so far. Simply continue playing until all matches are found, and an alert box will pop up, announcing your win.
...
- JS issues with cards being clickable (therefore "flippable") while already flipped pair being checked (resolved)
...
- Continue exploring with CSS to make pages look cleaner and be more user friendly